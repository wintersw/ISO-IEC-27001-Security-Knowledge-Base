...
description: Examples of records that can demonstrate ISMS design, operation, review, and improvement.
category: Reference
difficulty: Beginner
applies_to:
  - ISO/IEC 27001:2022
...
Evidence should support a specific assertion. A policy can show that a requirement was defined, but it normally cannot prove that a recurring activity operated across the required population and period. Combine design documents with authoritative operational records, approvals, exceptions, remediation records, and review results.
...
| Audit | Audit plan, samples, findings, reports |
| Management review | Agenda, inputs, minutes, decisions, actions |

---
title: Related Document Map
description: Cross-reference map to avoid duplicating ISMS content across chapters.
category: Reference
difficulty: Beginner
applies_to:
  - ISO/IEC 27001:2022
...
# Related Document Map

Use this map to link to existing guidance rather than duplicating content.
...
- [Risk Assessment Methodology](../05-risk-management/risk-methodology.md)
- [Risk Register](../05-risk-management/risk-register.md)
- [Risk Treatment and Residual Risk](../05-risk-management/risk-treatment.md)
...
- [ISMS Documentation Template Pack](../22-isms-documentation-template-pack/index.md)
- [How to Apply the Templates](../22-isms-documentation-template-pack/how-to-apply-templates.md)
- [ISMS Document Lifecycle](../22-isms-documentation-template-pack/document-lifecycle.md)
- [Document Control Procedure Template](../10-templates/document-control-procedure-template.md)

## Framework relationships

- [Ethics and Framework Relationships](../21-ethics-and-framework-relationships/index.md)
- [Framework Relationship Map](../21-ethics-and-framework-relationships/framework-relationship-map.md)
- [ISO/IEC 27000 Family Relationship](../21-ethics-and-framework-relationships/iso-iec-27000-family-relationship.md)

## Link maintenance rule

When adding a new chapter, link to related guidance in this map and add a short “Related documents” section to the new page. Avoid repeating full explanations where a mature page already exists.

## PDF source integration

- [PDF Source Integration Overview](../24-pdf-source-integration/index.md)
- [Source Gap Analysis](../24-pdf-source-integration/source-gap-analysis.md)
- [ISMS Building-Block Model](../24-pdf-source-integration/isms-building-block-model.md)
- [Enhanced ISMS Implementation Roadmap](../24-pdf-source-integration/implementation-roadmap-from-sources.md)
- [ISMS Process Architecture](../24-pdf-source-integration/isms-process-architecture.md)
- [ISMS Operating Process Catalog](../24-pdf-source-integration/isms-operating-process-catalog.md)
- [Certification and Scope Assurance](../24-pdf-source-integration/certification-and-scope-assurance.md)
- [Regulatory Readiness Operating Model](../24-pdf-source-integration/regulatory-readiness-operating-model.md)

## Modern data security expansion
...
- [Emerging Data Security Trends](../29-emerging-data-security-trends/index.md)
- [Source Research and Mapping](../30-source-research-and-mapping/index.md)

## Security lifecycle and IT governance
...
## Governance, Secure by Design, case studies, labs, and risk scenarios

...
description: Data-centric governance extension aligned with ISO 27001.
...
```mermaid
flowchart LR
    A[Business Objectives] --> B[Data Assets]
    B --> C[Classification]
    C --> D[Lifecycle Controls]
    D --> E[Monitoring and Evidence]

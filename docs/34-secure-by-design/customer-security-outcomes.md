...
A feature is not the same as an outcome. A product may support MFA, but customers remain exposed if MFA is difficult to configure, unavailable for administrators, or disabled by default.

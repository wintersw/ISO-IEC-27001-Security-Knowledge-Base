...
This exact template is not an ISO requirement; it is guidance for recording the **SoA** consistently. Controlled values, named owners, timestamps, approvals, and authoritative evidence improve assurance.

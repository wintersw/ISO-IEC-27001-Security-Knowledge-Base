...
For recurring and event-driven ISMS communications, define the audience, subject, trigger or frequency, sender, approved content or decision authority, channel, confidentiality needs, response or escalation expectation, and retained record. Include external communications where customers, suppliers, authorities, certification bodies, or other interested parties are relevant.

Do not confuse sending a message with achieving awareness. For critical topics, verify receipt, understanding, or action through acknowledgement, exercises, questions, observed behavior, or workflow completion.

### Practical communication example

A material supplier incident triggers a pre-agreed sequence: the incident lead informs the executive risk owner and legal contact within the defined threshold; the supplier manager uses the contractual channel; customer communication requires authorized facts and approval; and the incident record retains the time, audience, decision, message version, and follow-up.

...
| Exception | VPN without MFA for legacy system — compensating: IP whitelist, separate VLAN, quarterly review | CISO approval | Review quarterly, expire after two quarters (Q+2) |

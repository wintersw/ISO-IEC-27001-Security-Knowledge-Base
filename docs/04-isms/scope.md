...
The scope identifies the organizational units, locations, processes, technologies, services, information, and interfaces covered by the ISMS.
...
- Is understandable to customers and staff
- Covers dependencies needed to deliver in-scope services
- Identifies interfaces with excluded areas
- Avoids misleading exclusions
- Matches real operational responsibility
...
- **ISO requirement:** This chapter explains **ISMS Scope** without reproducing standard text. Determine formal obligations from the applicable clauses, scope, risk treatment, Statement of Applicability, and binding legal or contractual requirements.

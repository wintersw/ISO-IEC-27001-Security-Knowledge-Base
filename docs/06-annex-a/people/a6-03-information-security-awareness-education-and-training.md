...
description: Starter page for A.6.3 Information security awareness, education and training; expand using the Annex A control page template.
category: Annex A
...
A new contractor receives role-based access only after screening, agreement, manager approval, and security onboarding. At contract end, access and equipment are promptly returned and verified.

...
description: Starter page for A.8.32 Change management; expand using the Annex A control page template.
category: Annex A
...
A firewall rule is requested for a partner integration. The change record identifies affected services, data classification, source and destination, expiry, test plan, approval, logging, and rollback.

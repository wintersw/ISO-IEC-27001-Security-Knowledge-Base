...
The purpose of A.8.23 is to reduce the likelihood or impact of failures related to **web filtering**. A well-designed control makes the expected outcome, accountability, operating trigger, exception path, and assurance method clear enough to be repeated and tested.

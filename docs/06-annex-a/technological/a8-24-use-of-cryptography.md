...
description: Starter page for A.8.24 Use of cryptography; expand using the Annex A control page template.
category: Annex A
...
Sensitive backups are encrypted with centrally managed keys. Key owners, rotation, recovery, access, algorithm standards, and retirement are documented and tested.

...
description: Starter page for A.8.13 Information backup; expand using the Annex A control page template.
category: Annex A
...
A monthly restore test selects a production database backup, restores it into an isolated environment, verifies integrity and access, measures recovery time, and records corrective actions for failures.

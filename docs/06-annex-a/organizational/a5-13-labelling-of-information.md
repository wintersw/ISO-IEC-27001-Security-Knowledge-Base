...
description: Starter page for A.5.13 Labelling of information; expand using the Annex A control page template.
category: Annex A
...
Customer support exports contain names, email addresses, and ticket content. The data owner classifies them as confidential, requires encrypted storage, restricts sharing, and defines deletion after the approved purpose ends.

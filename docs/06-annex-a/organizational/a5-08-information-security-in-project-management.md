...
description: Starter page for A.5.8 Information security in project management; expand using the Annex A control page template.
category: Annex A
...
A business project introduces a new customer analytics platform. Security requirements for data classification, access, logging, supplier assurance, retention, and incident response are added to the project plan before procurement.

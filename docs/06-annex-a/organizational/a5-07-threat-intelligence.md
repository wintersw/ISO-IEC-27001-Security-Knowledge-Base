...
The purpose of A.5.7 is to reduce the likelihood or impact of failures related to **threat intelligence**. A well-designed control makes the expected outcome, accountability, operating trigger, exception path, and assurance method clear enough to be repeated and tested.

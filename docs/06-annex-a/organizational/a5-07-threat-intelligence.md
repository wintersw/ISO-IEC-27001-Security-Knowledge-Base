...
description: Starter page for A.5.7 Threat intelligence; expand using the Annex A control page template.
category: Annex A
...
A vulnerability advisory reports active exploitation of a component used in an internet-facing service. The threat-intelligence process validates relevance, identifies affected assets, raises the vulnerability priority, informs detection rules, and records the decision.

...
description: Starter page for A.5.28 Collection of evidence; expand using the Annex A control page template.
category: Annex A
...
During an investigation, identity logs, endpoint alerts, application records, and change tickets are collected with timestamps, integrity checks, restricted storage, and chain-of-custody records.

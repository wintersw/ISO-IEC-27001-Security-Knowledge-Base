...
description: Starter page for A.5.25 Assessment and decision on information security events; expand using the Annex A control page template.
category: Annex A
...
A SIEM alert shows unusual bulk export from a support account. The incident team validates the event, contains the account, preserves logs, assesses affected data, escalates notification decisions, and records lessons learned.

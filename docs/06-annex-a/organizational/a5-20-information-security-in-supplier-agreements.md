...
description: Starter page for A.5.20 Information security in supplier agreements; expand using the Annex A control page template.
category: Annex A
...
A SaaS provider processes confidential customer data. The organization tiers it as high risk, reviews security and continuity evidence, adds incident and deletion clauses, records subprocessors, and performs annual review.

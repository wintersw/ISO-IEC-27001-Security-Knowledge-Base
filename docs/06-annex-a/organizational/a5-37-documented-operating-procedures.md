...
The purpose of A.5.37 is to reduce the likelihood or impact of failures related to **documented operating procedures**. A well-designed control makes the expected outcome, accountability, operating trigger, exception path, and assurance method clear enough to be repeated and tested.

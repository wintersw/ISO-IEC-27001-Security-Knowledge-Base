...
description: Explains IT governance concepts and their relevance to the ISMS.
...
IT governance ensures that technology decisions support business objectives, manage risk, use resources responsibly, and deliver value.

## Core IT governance questions

- Are technology investments aligned with business strategy?
- Are risks understood and accepted by accountable owners?
- Are roles and decision rights clear?
- Are service performance and security outcomes measured?
...
If a critical legacy system cannot be patched, IT governance should decide whether to fund replacement, add compensating controls, accept risk temporarily, or retire the service. The ISMS records the risk, treatment decision, control status, and evidence.

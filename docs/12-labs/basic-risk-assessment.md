...
One documented risk scenario with treatment and residual-risk decision.

## Steps

1. Choose one critical asset.
2. Identify one realistic threat.
3. Identify one vulnerability or condition.
4. Describe business consequence.
5. Score impact and likelihood.

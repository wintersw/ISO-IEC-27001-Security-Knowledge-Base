...
description: How to integrate ISMS with QMS, BCMS, ITSM, risk management, privacy, and internal control systems.
...
- reduced duplication
- shared evidence
- consistent audit program
- improved employee acceptance
- central reporting
- better resource use
- clearer management view

## Integration principles

- keep one authoritative document register
- maintain one improvement backlog where practical
- align audit programs
- reuse service-management workflows
- define shared controls
- map evidence once to multiple requirements
- avoid conflicting risk-rating models

## Example integration

A change-management process can support:

- ITSM change control
- ISO 27001 operational control
- secure development

---
title: Topic and Reference Inventory
description: Topic coverage and authoritative public references used to maintain the knowledge base.
...
# Topic and Reference Inventory

This inventory connects major subject areas to the project sections that explain them. It intentionally records topics rather than the titles of background books or supplied summaries. Maintainers should use current, authoritative public references when validating or extending the content.

| Topic area | Coverage in this project | Project sections |
|---|---|---|
| Data security governance | Data ownership, lifecycle, classification, lineage, data-centric architecture, and control assurance | 25 Data Security Governance |

---
title: External Reference Register
...
External references are used as current background. Project pages are written in original language and tailored to ISO/IEC 27001 implementation.

## Governance and product-security references added in the enrichment edition

...
| 4 | *ISO/IEC 27000:2018 — Overview and vocabulary* | Adopted through paraphrased distinctions | The [Glossary](../15-reference/glossary.md) now distinguishes related management-system, measurement, risk, and incident terms in original plain language. | Formal definitions were not copied. Readers must use an authorized standard for normative terminology. |

...
| 4 | *ISO/IEC 27000:2018 — Overview and vocabulary* | Adopted through paraphrased distinctions; legacy reference | The [Glossary](../15-reference/glossary.md) distinguishes related management-system, measurement, risk, and incident terms in original plain language, while [Terminology Governance](../15-reference/terminology-governance.md) controls edition-aware use. | Formal definitions were not copied. ISO now lists the 2018 edition as withdrawn and revised by ISO/IEC 27000:2026; use it only for historical traceability and validate current terminology against applicable sources. |
